...
function MiniChart() {
  ...
  { label: t.landing.heroStats.totalCap, value: formatMarketCap(MOCK_GLOBAL.total_market_cap), icon: <BarChart3 className="h-4 w-4" />, trend: MOCK_GLOBAL.market_cap_change_24h },
  { label: t.landing.heroStats.volume24h, value: formatMarketCap(MOCK_GLOBAL.total_volume_24h), icon: <Activity className="h-4 w-4" /> },
  { label: t.landing.heroStats.btcDominance, value: `${formatNumber(MOCK_GLOBAL.btc_dominance)}%`, icon: <TrendingUp className="h-4 w-4" /> },
  { label: t.landing.heroStats.activeCryptos, value: formatNumber(MOCK_GLOBAL.active_cryptocurrencies), icon: <Globe className="h-4 w-4" /> },
];
